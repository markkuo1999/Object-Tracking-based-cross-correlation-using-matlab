function [affs,rects,points, scales, rotations, time] = tracker_camera(videoObject, pos, target_sz, rot, ...
	 show_visualization)
  
    %% initialize the tracker
    [p,pos,target_sz] = init_camera(videoObject, pos, target_sz, rot, show_visualization);
