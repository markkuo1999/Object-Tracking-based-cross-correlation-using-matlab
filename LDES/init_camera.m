function [ p,pos,target_sz ] = init_camera(videoObject, pos, target_sz, rot, show_visualization)
...
%   Detailed explanation goes here
	...
	%% learning window size, taking padding into account* (1 + padding) %padding : 在圖片中填充像素%
...
%     yf_scale = fft2(y_scale);
    ...
    if show_visualization, 
        p.update_visualization = show_camera(videoObject, 0);
    end
